...
class OptFlow {
  ...
  public void run(String[] args) {
    ...
    Imgproc.goodFeaturesToTrack(old_gray, p0MatofPoint, 100, 0.01, 7, new Mat(), 7, false, 0.04);
    ...
    while (true) {
      ...
      Video.calcOpticalFlowPyrLK(old_gray, frame_gray, p0, p1, status, err, new Size(15, 15), 2,
          criteria);
