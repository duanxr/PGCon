...
public class GuiConsoleLogger{
  ...
  static class LogView extends ListView<LogRecord> {
  ...
  public static class LogViewer extends Application {
    ...
    public void start(Stage stage) throws Exception {
      ...
      scene.getStylesheets().add(
          this.getClass().getResource("/javafx/javafx.css").toExternalForm()
      );
