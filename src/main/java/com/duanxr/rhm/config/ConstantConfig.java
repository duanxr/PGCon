...
public class ConstantConfig {
  ...
  public static final String MAIN_PANEL_TITLE = "Relentless Hatching Machine - by mytq(nga)&duanxr(github)";
  ...
  public static final int OUTPUT_HOLD_TIME = 75;
  ...
  public static final double TEMPLATE_MATCH_THRESHOLD = 0.98d;
