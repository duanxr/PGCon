package com.duanxr.rhm.core.gui;

import static com.duanxr.rhm.config.ConstantConfig.MAIN_PANEL_TITLE;
import static com.duanxr.rhm.config.ConstantConfig.MAIN_PANEL_VIDEO_FRAME_DELAY;
import static com.duanxr.rhm.config.ConstantConfig.MAIN_PANEL_VIDEO_RETRY_DELAY;
import static com.duanxr.rhm.config.ConstantConfig.SIZE;

import com.duanxr.rhm.cache.ScriptCache;
import com.duanxr.rhm.cache.ScriptLoader;
import com.duanxr.rhm.cache.entity.CachedImageArea;
import com.duanxr.rhm.core.execute.ScriptRunner;
...
import com.duanxr.rhm.io.input.Image.CameraImageInput;
import com.duanxr.rhm.io.output.controller.SerialControllerOutput;
...
public class ControlPanel extends JFrame {
  ...
  private void addScriptSelection() {
    ...
    ControlBox<String> controlBox = new ControlBox<>(this::selectScript, "选择执行脚本");
  ...
  private void addOutputSelection() {
    ...
    ControlBox<String> controlBox = new ControlBox<>(this::selectOutputPort, "选择输出端口");
  ...
  private void addVideoSelection() {
    ...
    ControlBox<Integer> controlBox = new ControlBox<>(this::selectVideo, "选择视频源");
  ...
  private void showVideo() {
    while (inputHandler != null) {
      try {
        ...
        videoLabel.repaint();
        Thread.sleep(MAIN_PANEL_VIDEO_FRAME_DELAY);
      } catch (Exception e) {
