...
public enum BoxArrowLocation {
  ...
  public int col;
  public int row;
  public CachedImageArea area;

  BoxArrowLocation(boolean canPutPokemon, boolean inBox, int col, int row, int top,
      int bottom, int left, int right) {
    this.canPutPokemon = canPutPokemon;
    this.inBox = inBox;
    this.col = col;
    this.row = row;
    this.area = new CachedImageArea(left, top, right, bottom);
